	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if ("getOne_For_Display".equals(action)) { // 來自select_page.jsp的請求
			...
			if (!errorMsgs.isEmpty()) {
				RequestDispatcher failureView = req.getRequestDispatcher("/Discount/select_page.jsp");
			...
			/*************************** 3.查詢完成,準備轉交(Send the Success view) *************/
				...
				String url = "/Discount/listOneDiscount.jsp";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
		if ("getOne_For_Update".equals(action)) { // 來自listAllEmp.jsp的請求
			...
			String url ="/Discount/update_discount_input.jsp"; 
		...
		if ("update".equals(action)) { // 來自update_emp_input.jsp的請求
			...
			if (!errorMsgs.isEmpty()) {
				...
				RequestDispatcher failureView = req
						.getRequestDispatcher("/Discount/update_discount_input.jsp");
				failureView.forward(req, res);
				return; //程式中斷
			}
			/*************************** 2.開始修改資料 *****************************************/
...
if ("insert".equals(action)) {  // 來自addDiscount.jsp的請求
			...
			DiscountVO.setDiscount_nar(discount_nar);
				...
				if (!errorMsgs.isEmpty()) {
					req.setAttribute("DiscountVO", DiscountVO); // 含有輸入格式錯誤的empVO物件,也存入req
					RequestDispatcher failureView = req
							.getRequestDispatcher("/Discount/addDiscount.jsp"); 
					failureView.forward(req, res);
					return; //程式中斷
				}
				/***************************2.開始新增資料***************************************/
				...
				String url = "/Discount/listAllDiscount.jsp";
