...
<ul>
  <li><a href='listAllGroupBuyItem.jsp'>List</a> all Discount.  <br><br></li>
  
  
  <li>
    <FORM METHOD="post" ACTION="groupBuyItem.do" >
        <b>輸入團購商品編號:</b>
        <input type="text" name="gbitem_id">
        <input type="hidden" name="action" value="getOne_For_Display">
        <input type="submit" value="送出">
    </FORM>
  </li>

  <jsp:useBean id="gbiSvc" scope="page" class="com.group_buy_item.model.Group_Buy_ItemService" /> 
   
  <li>
     <FORM METHOD="post" ACTION="groupBuyItem.do" >
       <b>選擇團購商品編號:</b>
       <select size="1" name="gbitem_id">
